...
# Reference: https://gist.github.com/JohnCEarls/8172807
...
class MPIFileHandler(logging.FileHandler):    
    def __init__(self,filename, mode=MPI.MODE_WRONLY|MPI.MODE_CREATE|MPI.MODE_APPEND , encoding="utf-8", delay=0, comm=MPI.COMM_WORLD ):
