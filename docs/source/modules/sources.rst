...
.. code-block:: python
    ...
    sources.dataloader import get_loader
...
Dataloader objects are generated by the :meth:`sources.dataloader.get_loader` object factory, 
passing only the `Delta` configuration to the factory. Internally, :meth:`sources.dataloader.get_loader`
